...
const Popup = ({products, setProducts, popupOpen, setPopupOpen}) => {
    ...
    return (
        <div className="overlay" style={{display: popupOpen === true ? 'flex' : 'none'}} onClick={closePopupFormCLickOnOverlay}>
            <form className="popup__form" onSubmit={addCard}>
                ...
                <button className='popup__form-btn' type='submit'>Дабавить</button>
